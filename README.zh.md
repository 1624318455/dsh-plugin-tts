...
<p align="center"><strong><a href="README.md#中文">中文</a> | <a href="README.md#english">English</a></strong></p>

---

# dsh-plugin-tts — Edge TTS 语音大集成

**第一次用？先看 [《使用手册（执行手册）》](docs/USER-GUIDE.md)**——每一步都有
"做什么 / 怎么做 / 怎么算成功"，从朗读、RVC 音色到音色包下载全覆盖。

完整文档见 [README.md 的「中文」章节](README.md#中文)（含功能、安装、音色表、架构、疑难排查与开发说明）。

本文件仅为中文索引页；README.md 为双语主文档。
