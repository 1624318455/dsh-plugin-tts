// @memef1f1y/dsh-plugin-tts — Client half (browser bundle).
...
window.__ModuleLoader__.load({
  ...
  factory: require => {
    ...
    const CLIENT_BUILD = "2026-09-26.05-follow-v2-fix";
    const apply = ctx => {
      ...
      const I18N = {
        ...
        dict: {
          zh: {
            ...
            "diag.title": "诊断",
            "diag.desc": "一键检查：Edge TTS 在线合成、本地 RVC 服务与模型、本地 Index-TTS2 服务与参考音色、本地 CosyVoice 服务与提示音频",
            "diag.running": "检查中…（约 1-2 秒）",
            "diag.run": "运行诊断",
            "diag.fail": "诊断失败：",
            "diag.exportLog": "导出诊断日志",
            "diag.exported": "诊断日志已导出（JSON 文件，失败时已改为复制到剪贴板）",
            "diag.exportFail": "导出失败，请手动截图诊断区：",
            "packs.title": "音色包",
            ...
            "provider.help": "Edge TTS：免费在线音色，开箱即用；自定义音色（RVC）：用你自己训练的模型，需先启动转换服务；本地音色（Index-TTS2）：用本机 index-tts2-nvidia 包的参考音频音色，需先双击「启动api服务.bat」；本地克隆（CosyVoice）：用本机 CosyVoice-2.0-0.5B 包的提示音频零样本克隆，需先双击「启动cosy服务.bat」；Cloud TTS：谷歌付费在线音色（中文标准/波形），需自备 API Key",
            "provider.rvc": "自定义音色（RVC）",
            "provider.index": "本地音色（Index-TTS2）",
            "provider.cosy": "本地克隆（CosyVoice）",
            "provider.cloud": "Cloud TTS（谷歌付费）",
            "section.cloud": "Cloud TTS 配置",
            "cloud.desc": "谷歌 Cloud Text-to-Speech 付费音色：中文标准音色每月前 400 万字符免费，Wavenet/Neural2 每月前 100 万字符免费，超出后按量计费。Key 只保存在本机 Host 文件（~/.dsh/tts-rvc/settings.json），不会进浏览器存储",
            "cloud.onboard.title": "首次使用 Cloud TTS？三步上手",
            "cloud.onboard.desc": "用谷歌付费音色朗读需要：① 在 Google Cloud Console 建项目并启用 Text-to-Speech API；② 创建 API Key 并粘贴到下方保存；③ 选音色后点「测试连接」确认。",
            "cloud.voice": "Cloud 音色",
            "cloud.voice.tip": "决定朗读是谁的声音：cmn-CN 中文组（推荐 Wavenet-A）；也可直接输入其他 voice id（如 Neural2/Chirp），Host 按名称自动归档计费",
            "cloud.voice.custom": "直接输入 voice id…",
            "cloud.key": "API Key",
            "cloud.key.tip": "Google Cloud Console → API 和服务 → 凭据 → 创建 API Key；输入后点「保存配置」，输入框会清空（Key 只存本机文件，不回显）",
            "cloud.key.placeholder": "AIza…（粘贴后点保存配置）",
            "cloud.key.saved": "已保存",
            "cloud.project": "Project ID（可选）",
            "cloud.project.tip": "Google Cloud 项目 ID；当前版本仅做记录（官方额度查询需服务账号，默认不启用），不填也能用",
            "cloud.save": "保存配置",
            "cloud.saving": "保存中…",
            "cloud.saved": "已保存。",
            "cloud.clear": "清除 Key",
            "cloud.cleared": "已清除 Key。",
            "cloud.confirmClear.lead": "确定清除已保存的 API Key",
            "cloud.confirmClear.tail": "？清除后 Cloud 朗读不可用。",
            "cloud.test": "测试连接",
            "cloud.testing": "测试中…",
            "cloud.test.ok": "连接正常（已合成一句测试语音，字符已计入本月用量）。",
            "cloud.usage.title": "本月用量（本地计数）",
            "cloud.usage.refresh": "刷新用量",
            "cloud.usage.loading": "读取中…",
            "cloud.usage.standard": "Standard（免费额度 400 万/月）",
            "cloud.usage.wavenet": "Wavenet（免费额度 100 万/月）",
            "cloud.usage.neural2": "Neural2（免费额度 100 万/月）",
            "cloud.usage.chirp3": "Chirp 3（免费额度 100 万/月）",
            "cloud.usage.unit": "字符",
            "cloud.usage.localNote": "本地按发送字符计数（含 SSML 标签），每月 1 号自动清零；官方控制台用量以 Google Cloud Billing 为准。",
            "host.cloudNoKey": "未配置 Google Cloud TTS API Key",
            "host.cloudKeyBad": "API Key 看起来太短，请检查是否粘贴完整",
            "host.cloudKeyInvalid": "Cloud TTS Key 无效或未启用 Text-to-Speech API",
            "host.cloudBadRequest": "Cloud TTS 拒绝请求（单包可能超限或 voice 无效）",
            "host.cloudHttpFail": "Cloud TTS 合成失败",
            "host.cloudNoAudio": "Cloud TTS 返回的音频异常",
            "section.cosy": "CosyVoice 配置",
            "cosy.desc": "连接本机 CosyVoice-2.0-0.5B 服务（默认 http://127.0.0.1:7890），用提示音频零样本克隆朗读。先双击本地包里的「启动cosy服务.bat」（保持窗口运行），再点「刷新音色」选提示音频试听",
            "cosy.onboard.title": "首次使用 CosyVoice？三步上手",
            "cosy.onboard.desc": "用本地提示音频克隆朗读需要：① 本机正在运行的 cosy-server.py 服务；② prompts 目录里有提示音频（5-20 秒人声最佳）。",
            "cosy.onboard.steps": "① 双击本地包里的「启动cosy服务.bat」（保持窗口运行，默认 7890 端口）；\n② 在下方点「刷新音色」，确认能看到提示音频列表；\n③ 选一个提示音频，点「一键诊断」确认服务在线。",
            "cosy.field.baseUrl": "服务地址",
            "cosy.field.baseUrl.tip": "一般保持默认：本地 CosyVoice 服务的地址（默认 7890 端口）",
            "cosy.field.voice": "提示音频",
            "cosy.field.voice.tip": "决定朗读是谁的声音：来自本地包 prompts 目录的提示音频；点「刷新音色」同步最新列表，也可直接粘贴文件名或上传新音频",
            "cosy.refresh": "刷新音色",
            "cosy.refreshing": "刷新中…",
            "cosy.voices.none": "暂无提示音频：请往本地包 prompts 目录放 wav/mp3，或用下方上传",
            "cosy.voices.fail": "提示音频列表读取失败：",
            "cosy.upload": "上传提示音频",
            "cosy.uploading": "上传中…",
            "cosy.upload.ok": "已上传：",
            "cosy.upload.fail": "上传失败：",
            "cosy.upload.tip": "支持 wav/mp3/flac/m4a/ogg，建议 5-20 秒清晰人声，会自动存入本地包 prompts 并可直接选用",
            "cosy.field.speed": "语速",
            "cosy.field.speed.tip": "0.5 慢速 ~ 2.0 快速，1.0 为正常",
            "cosy.field.seed": "随机种子",
            "cosy.field.seed.tip": "0 = 每次随机；填固定值可复现同一次合成",
            "cosy.field.promptText": "提示音频文字稿",
            "cosy.field.promptText.tip": "提示音频里说的内容，按顺序全文填写（多语 prompt 必须中英日三段全写，否则模型会把缺的那段复读一遍再读新文字）",
            "cosy.field.promptText.placeholder": "如：大家好我是… Please subscribe… 私の…",
            "host.cosyUnreachable": "无法连接本地 CosyVoice 服务",
            "host.cosyHttpFail": "CosyVoice 接口失败",
            "host.cosyNoAudio": "CosyVoice 返回的音频异常",
            "host.cosyNeedsServer": "无法连接本地 CosyVoice 服务",
            "host.cosyVoicesFail": "CosyVoice 提示音频列表接口异常",
            "host.cosyUploadFail": "提示音频上传失败",
            ...
            "chunk.stalling": " 段 · 下一段合成中…",
            "overlay.reading": "朗读中",
            "overlay.paused": "已暂停",
            "overlay.showToggle": "显示全局朗读中按钮（实验性，默认关闭）",
            "overlay.showToggle.desc": "屏幕右侧显示朗读进度浮窗，可点击暂停/继续",
            "scrollFollow.label": "朗读高度跟随（实验性，默认关闭）",
            "scrollFollow.desc": "朗读时自动滚动对话区域，使正在朗读的段落保持可见；你一动手滚动就停下，可点浮条回到跟随",
            "follow.resume": "回到跟随",
            "footnote": "由 Microsoft Edge TTS / 本地 RVC / 本地 Index-TTS2 / 本地 CosyVoice / Google Cloud TTS 驱动。",
            "report.hint.lead": "遇到问题？点上方诊断区的「导出诊断日志」，把 JSON 附到 ",
            "report.hint.tail": " 提 issue；不方便用 GitHub 时再通过其他方式发给开发者，本地服务报错另附服务终端里的红色报错。",
                        "err.chunkFail": "后续段落合成失败：",
            "err.audioDecode": "音频解码失败：",
            "err.chunkSkip": "某段音频加载失败，已跳过",
            "err.synthFailShort": "语音合成失败",
            "err.synthTimeout": "语音合成超时（55s）：Edge 端点无响应，请检查网络后重试",
...
"tab.voice": "语音",
          ...
          en: {
            ...
            "diag.desc": "One-click check: Edge TTS synthesis, local RVC service + model, local Index-TTS2 service + reference voices, local CosyVoice service + prompts",
            "diag.running": "Checking… (about 1-2s)",
            "diag.run": "Run diagnostics",
            "diag.fail": "Diagnostics failed: ",
            "diag.exportLog": "Export diagnostic log",
            "diag.exported": "Diagnostic log exported (JSON file; fell back to clipboard on failure)",
            "diag.exportFail": "Export failed, please screenshot the diagnostics area instead: ",
            ...
            "provider.help": "Edge TTS: free online voices, works out of the box; Custom voice (RVC): use your own trained model, requires starting the conversion service; Local voice (Index-TTS2): reference-audio voices from your local index-tts2-nvidia bundle, requires its API service; Local clone (CosyVoice): zero-shot cloning with prompt audio from your local CosyVoice-2.0-0.5B bundle, requires its service; Cloud TTS: paid Google voices (Chinese Standard/Wavenet), needs your own API key",
            "provider.rvc": "Custom voice (RVC)",
            "provider.index": "Local voice (Index-TTS2)",
            "provider.cosy": "Local clone (CosyVoice)",
            "provider.cloud": "Cloud TTS (Google, paid)",
            "section.cloud": "Cloud TTS Config",
            "cloud.desc": "Google Cloud Text-to-Speech paid voices: Chinese Standard voices are free for the first 4M chars/month, Wavenet/Neural2 free for the first 1M chars/month, then billed per use. The key is stored in the local Host file only (~/.dsh/tts-rvc/settings.json), never in browser storage",
            "cloud.onboard.title": "New to Cloud TTS? Three steps",
            "cloud.onboard.desc": "Reading with paid Google voices needs: ① a Google Cloud project with the Text-to-Speech API enabled; ② an API key pasted & saved below; ③ pick a voice and click “Test connection”.",
            "cloud.voice": "Cloud voice",
            "cloud.voice.tip": "Sets who reads: the cmn-CN Chinese group (Wavenet-A recommended); you can also type another voice id (e.g. Neural2/Chirp), the Host auto-tiers it for quota counting",
            "cloud.voice.custom": "Type a voice id…",
            "cloud.key": "API Key",
            "cloud.key.tip": "Google Cloud Console → APIs & Services → Credentials → Create API key; paste below and click Save — the input clears after saving (the key lives in the local file, never echoed back)",
            "cloud.key.placeholder": "AIza… (paste, then save)",
            "cloud.key.saved": "saved",
            "cloud.project": "Project ID (optional)",
            "cloud.project.tip": "Google Cloud project ID; recorded only for now (official quota queries need a service account and stay off by default) — works fine empty",
            "cloud.save": "Save config",
            "cloud.saving": "Saving…",
            "cloud.saved": "Saved.",
            "cloud.clear": "Clear key",
            "cloud.cleared": "Key cleared.",
            "cloud.confirmClear.lead": "Clear the saved API key",
            "cloud.confirmClear.tail": "? Cloud reads will stop working.",
            "cloud.test": "Test connection",
            "cloud.testing": "Testing…",
            "cloud.test.ok": "Connection OK (a test clip was synthesized; its chars count toward this month).",
            "cloud.usage.title": "This month's usage (local count)",
            "cloud.usage.refresh": "Refresh usage",
            "cloud.usage.loading": "Loading…",
            "cloud.usage.standard": "Standard (free 4M/month)",
            "cloud.usage.wavenet": "Wavenet (free 1M/month)",
            "cloud.usage.neural2": "Neural2 (free 1M/month)",
            "cloud.usage.chirp3": "Chirp 3 (free 1M/month)",
            "cloud.usage.unit": "chars",
            "cloud.usage.localNote": "Counted locally per sent chars (incl. SSML tags), resets on the 1st of each month; Google Cloud Billing is authoritative.",
            "host.cloudNoKey": "Google Cloud TTS API key not configured",
            "host.cloudKeyBad": "The API key looks too short — check the paste",
            "host.cloudKeyInvalid": "Cloud TTS key invalid or Text-to-Speech API not enabled",
            "host.cloudBadRequest": "Cloud TTS rejected the request (packet may be over-limit or voice invalid)",
            "host.cloudHttpFail": "Cloud TTS synthesis failed",
            "host.cloudNoAudio": "Cloud TTS returned invalid audio",
            "section.cosy": "CosyVoice Config",
            "cosy.desc": "Connects to your local CosyVoice-2.0-0.5B service (default http://127.0.0.1:7890) and reads with zero-shot prompt cloning. Start “启动cosy服务.bat” in the bundle first (keep it running), then Refresh voices and pick one",
            "cosy.onboard.title": "New to CosyVoice? Three steps",
            "cosy.onboard.desc": "Reading with a local prompt clone needs: ① a running local cosy-server.py service; ② prompt audio in prompts (5-20s of clear speech works best).",
            "cosy.onboard.steps": "① Double-click “启动cosy服务.bat” in the bundle (keep it running, default port 7890);\n② Click “Refresh voices” below and confirm the list shows up;\n③ Pick a prompt audio and run diagnostics to confirm the service is online.",
            "cosy.field.baseUrl": "Service URL",
            "cosy.field.baseUrl.tip": "Usually keep default: the local CosyVoice service address (default port 7890)",
            "cosy.field.voice": "Prompt audio",
            "cosy.field.voice.tip": "Sets who reads: a prompt audio from the bundle's prompts folder; Refresh syncs the list, or paste a filename / upload new audio",
            "cosy.refresh": "Refresh voices",
            "cosy.refreshing": "Refreshing…",
            "cosy.voices.none": "No prompt audio yet: put wav/mp3 files into the bundle's prompts folder, or upload below",
            "cosy.voices.fail": "Failed to load prompt list: ",
            "cosy.upload": "Upload prompt audio",
            "cosy.uploading": "Uploading…",
            "cosy.upload.ok": "Uploaded: ",
            "cosy.upload.fail": "Upload failed: ",
            "cosy.upload.tip": "wav/mp3/flac/m4a/ogg supported, 5-20s of clear speech recommended; saved into the bundle's prompts and ready to use",
            "cosy.field.speed": "Speed",
            "cosy.field.speed.tip": "0.5 slow ~ 2.0 fast, 1.0 is normal",
            "cosy.field.seed": "Random seed",
            "cosy.field.seed.tip": "0 = random each time; a fixed value reproduces a synthesis",
            "cosy.field.promptText": "Prompt transcript",
            "cosy.field.promptText.tip": "What the prompt audio says, in order and in full (multilingual prompts must include every language part, or the model re-reads the missing part before new text)",
            "cosy.field.promptText.placeholder": "e.g. Hello everyone… Please subscribe…",
            "host.cosyUnreachable": "Cannot connect to the local CosyVoice service",
            "host.cosyHttpFail": "CosyVoice endpoint failed",
            "host.cosyNoAudio": "CosyVoice returned invalid audio",
            "host.cosyNeedsServer": "Cannot connect to the local CosyVoice service",
            "host.cosyVoicesFail": "CosyVoice prompt-list endpoint error",
            "host.cosyUploadFail": "Prompt audio upload failed",
            ...
            "chunk.stalling": " · next section synthesizing…",
            "overlay.reading": "Reading",
            "overlay.paused": "Paused",
            "overlay.showToggle": "Show global reading indicator (experimental, off by default)",
            "overlay.showToggle.desc": "Show a floating reading progress indicator on the right side; click to pause/resume",
            "scrollFollow.label": "Auto scroll while reading (experimental, off by default)",
            "scrollFollow.desc": "Auto-scroll the conversation to keep the spoken paragraph visible; stops the moment you scroll, resume from the floating bar",
            "follow.resume": "Resume follow",
            "footnote": "Powered by Microsoft Edge TTS / local RVC / local Index-TTS2 / local CosyVoice / Google Cloud TTS.",
            "report.hint.lead": "Hit a bug? Export the diagnostic log in Diagnostics above and attach the JSON to ",
            "report.hint.tail": " ; if GitHub is inconvenient, send it to the developer another way. For local-service errors also paste the red traceback from the service terminal.",
            ...
            "err.synthTimeout": "Speech synthesis timed out (55s): the Edge endpoint is not responding. Check your network and retry.",
...
"tab.voice": "Voice",
      ...
      const shared = {
        ...
        // Cloud Host state (transient, NEVER in localStorage): apiKeySet-tail
        // + projectId come from GET /dsh-tts-api/cloud-config. The API key
        // itself is write-only (password input, cleared after save).
        cloudHost: {
          apiKeySet: false,
          apiKeyTail: "",
          projectId: "",
        ...
        speaking: false,
        diagLog: [], // one-click diagnostic log: recent speak attempts + toasts (no message text, textLen only; cap 30)
        currentText: null,
        speakSource: null,
        speakToken: 0,
        ...
        readingCenterOnce: false, // first follow tick centres the message (click-initiated reads only)
        followHlEl: null,   // element currently carrying .dsh-tts-sentence-active (v2 block highlight)
        showReadingOverlay: false, // show the global reading progress overlay on the right (default off: follow still experimental)
        showScrollFollow: false,   // auto-scroll conversation to keep reading paragraph centred (default off: follow still experimental)
      ...
      // Fixed Cloud voice ids (ASCII labels, no i18n needed). Custom ids
      // (Neural2/Chirp/others) can be typed free-form in the same input.
      const CLOUD_VOICES = [
        "cmn-CN-Standard-A",
        "cmn-CN-Standard-B",
        "cmn-CN-Standard-C",
      ...
      // CosyVoice: same — only baseUrl is service-class.
      // Cloud: NO service-class key lives in localStorage — apiKey/projectId
      // are Host-file-only; voice is a local UI pref.
      ...
      function loadSettings() {
        try {
          ...
          if (data.provider === "edge-tts" || data.provider === "rvc" || data.provider === "index-tts2" || data.provider === "cosyvoice" || data.provider === "google-cloud-tts")
          ...
          // CosyVoice voice + params are local UI prefs (only baseUrl is
          // service-class). Same layered pattern as Index-TTS2.
          if (data.cosy && typeof data.cosy === "object") {
            for (const k in COSY_DEFAULTS) {
              if (k in data.cosy) shared.cosy[k] = data.cosy[k];
            }
          }
          // Cloud voice is a local UI pref (default Wavenet-A). Never accept
          // apiKey/projectId from localStorage even if an old build wrote them.
          if (data.cloud && typeof data.cloud === "object") {
            if (typeof data.cloud.voice === "string" && data.cloud.voice !== "") {
              shared.cloud.voice = data.cloud.voice;
            }
          }
      ...
      function saveSettings() {
        try {
          ...
          // and CosyVoice (only baseUrl is service-class). Cloud apiKey/projectId
          // NEVER persist to localStorage — they live in the Host file only; the
          // local copy carries the voice UI pref alone.
          ...
          const cosyLocal = Object.assign({}, shared.cosy);
          for (const k of HOST_COSY_KEYS) delete cosyLocal[k];
          const data = {
            ...
            index: indexLocal,
            cosy: cosyLocal,
            cloud: Object.assign({}, shared.cloud),
      ...
      function resetSettings() {
        ...
        shared.showReadingOverlay = false;
        shared.showScrollFollow = false;
        ...
        for (const k in COSY_DEFAULTS) shared.cosy[k] = COSY_DEFAULTS[k];
        for (const k in CLOUD_DEFAULTS) shared.cloud[k] = CLOUD_DEFAULTS[k];
        shared.cloudHost = { apiKeySet: false, apiKeyTail: "", projectId: "" };
        try {
          const store = globalThis.localStorage;
        ...
        try {
          pushHostCosy({ baseUrl: "" });
        } catch (e) {}
        try {
          pushHostCloud({ apiKey: "", projectId: "" });
        } catch (e) {}
        try {
          refreshCloudConfig();
        } catch (e) {}
      ...
      function pushHostCosy(patch) {
        try {
          fetch("/dsh-tts-api/cosy-config-save", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ cosy: patch }),
          }).catch(() => {});
        } catch (e) {}
      }
      // Cloud: apiKey/projectId are Host-file-only (write goes through
      // pushHostCloud; the key input is write-only and never echoed back).
      // refreshCloudConfig pulls the apiKeySet/tail/projectId display state.
      function pushHostCloud(patch) {
        try {
          fetch("/dsh-tts-api/cloud-config-save", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ cloud: patch }),
          }).catch(() => {});
        } catch (e) {}
      }
      function refreshCloudConfig() {
        try {
          fetch("/dsh-tts-api/cloud-config")
            .then(r => r.json().catch(() => null))
            .then(d => {
              try {
                const srv = (d && d.cloud) || {};
                const next = {
                  apiKeySet: srv.apiKeySet === true,
                  apiKeyTail: typeof srv.apiKeyTail === "string" ? srv.apiKeyTail : "",
                  projectId: typeof srv.projectId === "string" ? srv.projectId : "",
                };
                const prev = shared.cloudHost || {};
                if (prev.apiKeySet !== next.apiKeySet || prev.apiKeyTail !== next.apiKeyTail || prev.projectId !== next.projectId) {
                  shared.cloudHost = next;
                  notify();
                }
              } catch (e) {}
            })
      ...
      // Pull the Host CosyVoice service address once at startup (same layered
      // pattern as Index-TTS2: file wins; legacy local value migrates up once).
      function pullHostCosy() {
        try {
          fetch("/dsh-tts-api/cosy-config")
            .then(r => r.json().catch(() => null))
            .then(d => {
              try {
                const srv = (d && d.cosy) || {};
                ...
                try {
                  const raw = globalThis.localStorage
                    ...
                    : null;
                  const data = raw ? JSON.parse(raw) : null;
                  if (data && data.cosy && typeof data.cosy.baseUrl === "string" && data.cosy.baseUrl !== "") {
                    legacy = data.cosy.baseUrl;
                  }
                } catch (e) {}
                if (typeof srv.baseUrl === "string" && srv.baseUrl !== "") {
                  if (shared.cosy.baseUrl !== srv.baseUrl) {
                    shared.cosy.baseUrl = srv.baseUrl;
                    notify();
                  }
                } else if (legacy !== undefined) {
                  pushHostCosy({ baseUrl: legacy });
                }
              } catch (e) {}
            })
            .catch(() => {});
        ...
        if (typeof window !== "undefined")
          window.__dshTtsSettings = {
            get: () => ({
              ...
              cosy: Object.assign({}, shared.cosy),
              cloud: Object.assign({}, shared.cloud),
              notify: Object.assign({}, shared.notify),
            }),
            save: saveSettings,
      ...
      let toastTimer = null;
      // One-click diagnostic log: every user-visible failure funnels through
      // showToast (F-toast design), so hook it here to capture the failure
      // history in one place. Only trimmed text is kept, never audio/keys.
      function logDiag(entry) {
        try {
          shared.diagLog.push(Object.assign({ at: Date.now() }, entry));
          while (shared.diagLog.length > 30) shared.diagLog.shift();
        } catch (e) { /* logging must never break playback */ }
      }
      function showToast(text, kind, action) {
        logDiag({ kind: "toast:" + (kind || "error"), text: String(text).slice(0, 200) });
      ...
      // --- Scroll-follow v2 state: apply-scope singleton so BOTH speakText
      // (new-read re-latch) and TtsReadingOverlay (tick / takeover / resume)
      // share the SAME object. Must NOT live inside the component (each render
      // would recreate it: speakText would throw ReferenceError AND latch-off
      // would be lost on next render).
      const ttsFollow = { latched: true, touchActive: false, selfUntil: 0 };
      ...
      // Orphan sweep: a previous <audio> that still holds OUR audio but is
      // neither the managed player nor the spare (e.g. the host remounted
      // the overlay mid-read, moving the ref to a fresh element and leaving
      // the old one sounding). stopSpeaking()'s pause above cannot reach it,
      // so it would keep playing under the new utterance — the residual
      // one-off overlap on long reads. Only elements whose current src is our
      // own /dsh-tts-audio/ URL are touched; host/page audio is never paused.
      function sweepOrphanTtsAudio() {
        let els = null;
        try {
          if (typeof document === "undefined" || !document.querySelectorAll) return;
          els = document.querySelectorAll("audio");
        } catch (e) { return; }
        for (const a of els) {
          try {
            if (!a || a === shared.audioEl || a === shared.spareAudioEl) continue;
            const src = a.currentSrc || a.getAttribute("src") || "";
            if (src && src.indexOf("/dsh-tts-audio/") >= 0) {
              try { a.pause(); } catch (e) {}
      ...
      function stopSpeaking() {
        shared.speakToken += 1;
        // Playback generation: every stop/speak bumps playSeq; all audio
        // callbacks (onended/onerror/onended-of-chunks) must match the current
        // generation or drop silently. This kills the "two audios overlap"
        // race where an in-flight play() promise outlives pause()+src-swap.
        shared.playSeq = (shared.playSeq || 0) + 1;
        shared.speaking = false;
        shared.currentText = null;
        shared.speakSource = null;
        shared.chunkProgress = null;
        ...
        if (el) {
          ...
          // load() after src removal aborts the in-flight decode/fetch that
          // pause() alone cannot stop (the overlap-race root cause).
          try {
            el.load();
          } catch (e) {}
        }
        ...
        // Sweep remount-orphaned <audio> elements holding our audio (see
        // above): the managed pause cannot reach them. Covers every stop
        // path (button toggle, auto-read off, Esc/S shortcut, new utterance).
        sweepOrphanTtsAudio();
        if (shared.waCleanup) {
          try {
            shared.waCleanup();
        ...
        // Suspend the shared Web Audio clock too: scheduled-but-unplayed
        // sources are silenced immediately even if a stale cleanup missed them.
        // The next playChunks resumes it on demand.
        if (shared.audioCtx) {
          try {
            if (shared.audioCtx.state === "running") shared.audioCtx.suspend();
          } catch (e) {}
        }
      ...
      async function rpcSpeak(text, voice, provider) {
        ...
        } else if (useProvider === "cosyvoice") {
          // CosyVoice: timbre comes from the prompt audio (shared.cosy.voice);
          // the `voice` slot is only a fallback when nothing is chosen yet.
          // speed/seed travel in custom; no Edge prosody needed.
          payload.custom = Object.assign({}, shared.cosy, {
            voice: shared.cosy.voice || voice,
          });
        } else if (useProvider === "google-cloud-tts") {
          // Cloud: voice is the Cloud voice id; rate/pitch/volume reuse the
          // same sliders as Edge (no extra controls). The API key NEVER
          // travels through payload/custom — the Host reads it from its file.
          payload.voice = shared.cloud.voice || voice;
          payload.custom = { voice: shared.cloud.voice || voice };
          payload.prosody = {
        ...
        // Edge-only backstop: the Host caps an Edge synthesis at 45s, so abort
        // above that instead of hanging forever on a blackholed endpoint.
        // Other providers (rvc/index/cosy/cloud) can legitimately take minutes
        // on first model load — never abort those here.
        const edgeOnly = useProvider === "edge-tts";
        const ctrl = edgeOnly ? new AbortController() : null;
        const timer = edgeOnly
          ? setTimeout(() => { try { ctrl.abort(); } catch (e) {} }, 55000)
          : null;
        const t0 = Date.now();
        const logSpeak = (ok, error, extra) => logDiag(Object.assign({
          kind: "speak",
        ...
        try {
          const response = await fetch("/dsh-tts-api/speak", {
            ...
            ...(edgeOnly ? { signal: ctrl.signal } : {}),
          });
          const result = await response.json();
          logSpeak(!(result && result.error), result && result.error, { cached: !!(result && result.cached) });
          return result;
        } catch (e) {
          if (edgeOnly && e && e.name === "AbortError") {
            logSpeak(false, "abort-timeout-55s");
            throw new Error(t("err.synthTimeout"));
          }
          logSpeak(false, (e && e.message) || e);
          throw e;
        } finally {
      ...
      async function playChunks(jobId, initialUrls, total, token, onError) {
        // Capture the generation SYNCHRONOUSLY at entry: anything below may
        // await (ctx.resume), during which stopSpeaking()+speakText can bump
        // playSeq. Capturing after the await would adopt the NEW utterance's
        // generation and blind the seq guard below (stale chain overlapping
        // the fresh one on long chunked reads).
        const mySeq = shared.playSeq || 0;
        const stale = () => token !== shared.speakToken || shared.playSeq !== mySeq;
        ...
        if (ctx.state === "suspended") {
          ...
          // A stop/start during the resume await leaves this chain stale:
          // return WITHOUT touching the context or shared handles — the fresh
          // chain owns them now (resuming/suspending here would flip the new
          // utterance's clock).
          if (stale()) return;
        } else if (stale()) return;
        // Indexed queue: slots are filled BY CHUNK INDEX so out-of-order
        // fetch resolutions can never reorder playback. The Host converts
        // chunks serially (job.tail), but network resolve order is not
        // guaranteed — push-on-resolve used to scramble the order.
        const queue = new Array(total);
        for (let i = 0; i < initialUrls.length && i < total; i++) queue[i] = initialUrls[i];
        let cursor = 0;       // next queue index to decode (strictly in order)
        let fetched = initialUrls.length; // next chunk index to request
        ...
        const requestNext = () => {
          if (completed || inFlight || fetched >= total) return;
          const want = fetched++;
          inFlight = fetchNextChunk(jobId, token)
            .then(r => {
              inFlight = null;
              if (token !== shared.speakToken || shared.playSeq !== mySeq) return;
              if (r && r.url) queue[want] = r.url;
              else if (r && r.skipped) {
                // Host skipped a bad chunk after retry: mark the slot as
                // intentionally empty (not missing) so playback continues in
                // order; surface a non-fatal toast with the segment number.
                queue[want] = false;
                if (typeof onError === "function") onError(t("err.chunkSkip") + " (" + r.skipped + "/" + total + ")");
              }
              else if (r && r.error) {
                completed = true;
                ...
                completed = true;
                // Silent early end (GC'd/unknown job, cancelled Host job):
                // without this the player spins on "synthesizing…" forever
                // with no trace. Only fires when indices never arrived — a
                // clean drain has every queue slot filled.
                let served = 0;
                for (let i = 0; i < total; i++) if (queue[i] !== undefined) served++;
                if (served < total) {
                  try {
                    logDiag({ kind: "chunk-early-done", text: "job " + jobId + " ended with " + served + "/" + total + " chunks served" });
                  } catch (e) {}
                  if (typeof onError === "function") onError(t("err.chunkFail") + " (" + served + "/" + total + ")");
                }
              }
            })
            .catch(() => {
        ...
        // Cross-chain live-source registry: a single chain schedules strictly
        // back-to-back (start == previous end), so any time-overlap between
        // entries of DIFFERENT generations is a genuine double-audio event.
        // Same-generation entries are skipped; exact-boundary touches are not
        // flagged (0.05s tolerance). Diagnostic only: logs the two chain
        // generations to console + window for bug reports, never touches audio.
        const live = shared.waLive || (shared.waLive = new Set());
        if (live.size > 64) {
          try {
            const now = ctx.currentTime;
            for (const e of live) { if (e.end < now - 5) live.delete(e); }
          } catch (e) {}
        }
        const detectOverlap = (start, end) => {
          try {
            for (const e of live) {
              if (e.seq === mySeq) continue;
              if (e.start < end - 0.05 && start < e.end - 0.05) {
                const info = {
                  at: Date.now(), build: CLIENT_BUILD,
                  seqA: e.seq, seqB: mySeq,
                  aStart: e.start, aEnd: e.end, bStart: start, bEnd: end,
                };
                try { window.__dshTtsOverlap = info; } catch (err) {}
                try { console.warn("[tts] overlapping playback detected", info); } catch (err) {}
                break;
              }
            }
          } catch (e) {}
        ...
        const schedule = buf => {
          ...
          src.buffer = buf;
          // Fixed rate: NEVER stretch/slow a chunk to buy synthesis time.
          // playbackRate on AudioBufferSourceNode is varispeed (pitch drops
          // with speed, ~0.85x = nearly 3 semitones down = "voice gets
          // thicker"). The watchdog below only flips the "synthesizing…"
          // text; timing gaps are absorbed by the 200ms poll loop.
          src.playbackRate.value = shared.rate || 1; // mini-player speed
          src.connect(master);
          // Starvation clamp: when synthesis runs slower than playback
          // (local CosyVoice RTF > 1 sustained: ~12s synth for ~9s audio),
          // nextStart falls behind the sample clock. start() with a past time
          // plays IMMEDIATELY, but the bookkeeping still advances from the
          // past time — so the NEXT chunk is scheduled before this one truly
          // ends and the tails overlap, worse with every late chunk. Clamp to
          // now: a starved chunk becomes a tiny gap instead of an overlap;
          // exact gapless resumes once synthesis catches up.
          const start = Math.max(nextStart, ctx.currentTime + 0.02);
          const end = start + buf.duration / (src.playbackRate.value || 1); // wall-clock-consistent
          detectOverlap(start, end);
          src.start(start);
          nextStart = end;
          sources.add(src);
          const entry = { seq: mySeq, start, end };
          live.add(entry);
          const k = decoded;
          src.onended = () => {
            sources.delete(src);
        ...
        const cleanup = () => {
          ...
          sources.clear();
          try {
            for (const e of live) { if (e.seq === mySeq) live.delete(e); }
          } catch (e) {}
          try {
            master.disconnect();
          } catch (e) {}
        ...
        const finish = () => {
          ...
          cleanup();
          if (token === shared.speakToken && shared.playSeq === mySeq) clearSpeaking(token);
        };
        shared.waCleanup = () => {
          if (finished) return;
          finished = true;
        ...
        // Entry guards above all ran before any shared mutation, but a stop
        // racing the master-Gain creation still lands here: re-check before
        // claiming shared.waCleanup / emitting progress for a dead chain.
        if (stale()) return;
        try {
          setProgress(1);
          while (token === shared.speakToken && shared.playSeq === mySeq && !finished) {
            if (total - cursor >= 2) requestNext(); // top up URL queue
            if (cursor < total && queue[cursor] !== undefined && decoded - played < 2) {
              if (queue[cursor] === false) {
                // skipped chunk (Host retry exhausted): count it as played so
                // the chain advances without a gap in progress numbering.
                cursor++;
                played++;
                setProgress(cursor + 1 > total ? total : cursor + 1);
                if (played >= total) finish();
                continue;
              }
              ...
              try {
                ...
                if (token !== shared.speakToken || shared.playSeq !== mySeq) break;
                schedule(buf);
              } catch (e) {
            ...
            requestNext();
            // Watchdog: next chunk still missing while audio is in flight
            // (played < decoded) -> show "synthesizing…" instead of going
            // silent. Text-only: playback rate is never touched (varispeed
            // would deepen the timbre).
            if (!finished && played < decoded && cursor < total && queue[cursor] === undefined && !completed) {
              shared.stalling = true;
              notify();
            } else if (shared.stalling) {
              shared.stalling = false;
              notify();
            }
      ...
      async function playChunksAudio(jobId, initialUrls, total, token, onError) {
        const mySeq = shared.playSeq || 0;
        // Stale entry (a stop/start raced the async fallback hop from
        // playChunks): never append an orphan <audio> to the DOM nor claim
        // the shared spare for a dead chain.
        if (token !== shared.speakToken || shared.playSeq !== mySeq) return;
        ...
        // Indexed queue (same ordering guarantee as the Web Audio path).
        const queue = new Array(total);
        for (let i = 0; i < initialUrls.length && i < total; i++) queue[i] = initialUrls[i];
        let cursor = 0;
        let fetched = initialUrls.length;
        let completed = false; // host reported no more chunks
        let inFlight = null;
        let cur = elA;
        let spare = elB;
        ...
        const playOne = (url, index) =>
          new Promise(resolve => {
            ...
            cur.onended = () => { if (shared.playSeq === mySeq) fin(); else { clearInterval(cancelCheck); resolve(); } };
            cur.onerror = () => {
              fin();
              if (shared.playSeq === mySeq && typeof onError === "function") onError(t("err.chunkSkip"));
            };
            ...
            // Generation-gated too: a newer utterance bumps playSeq, so the
            // stale chain resolves without ever starting audio on the shared
            // element the fresh chain now owns.
            const cancelCheck = setInterval(() => {
              if (token !== shared.speakToken || shared.playSeq !== mySeq) fin();
            }, 150);
        ...
        try {
          while (token === shared.speakToken && shared.playSeq === mySeq) {
            if (total - cursor >= 2) requestNext(); // top up while comfortably buffered
            if (cursor < total && queue[cursor] !== undefined) {
              if (queue[cursor] === false) {
                // skipped chunk: advance silently (toast already shown at fetch)
                cursor++;
                setProgress(Math.min(cursor + 1, total));
                continue;
              }
              const url = queue[cursor];
          ...
          try { elB.load(); } catch (e) {}
          try { if (elB.parentNode) document.body.removeChild(elB); } catch (e) {}
          // Only release the shared spare when it is still ours: an older
          // chain's finally must never null out a newer chain's spare (that
          // orphaned the fresh spare from stopSpeaking() and leaked audio).
          if (shared.spareAudioEl === elB) shared.spareAudioEl = null;
        }
      }
      ...
      async function speakText(rawText, source, onError, opts) {
        ...
        shared.chunkSpans = null; // exact block spans arrive with chunked jobs (P1-3)
        // Playback-start timestamp for smooth scroll interpolation.
        shared.chunkStartedAt = Date.now();
        // Follow engaged fresh; centre-once only for click-initiated reads —
        // auto-read must never yank the view away from what the user reads.
        ttsFollow.latched = true;
        try { _ttsClearHighlight(); } catch (e) {}
        shared.readingCenterOnce = (source === "manual");
        ...
        try {
          ...
          if (Array.isArray(result.chunks) && result.chunks.length) {
            ...
            shared.chunkSpans = Array.isArray(result.spans) ? result.spans : null;
            shared.chunkProgress = { index: 1, total };
            notify();
            // Prewarm skips happened during /speak (not at /rvc-next time),
            // so the queue holes below would be walked over silently without
            // this: surface each one now like any on-demand skip.
            if (Array.isArray(result.skipped)) {
              for (const n of result.skipped) {
                if (typeof onError === "function") onError(t("err.chunkSkip") + " (" + n + "/" + total + ")");
              }
            }
          ...
          shared.currentJobId = null;
          // Generation-guarded callbacks: a stale onended/onerror from the
          // previous utterance must not touch the new playback state.
          const mySeq = shared.playSeq || 0;
          el.onended = () => { if (shared.playSeq === mySeq) clearSpeaking(token); };
          el.onerror = () => {
            if (shared.playSeq !== mySeq) return;
            clearSpeaking(token);
          ...
          // A stop/start during the play() pending window leaves this
          // continuation stale: report interrupted so callers (preview state)
          // never treat an orphaned play as the active utterance's success.
          if (token !== shared.speakToken || shared.playSeq !== mySeq) {
            return { ok: false, error: "interrupted" };
          }
          return { ok: true };
        } catch (e) {
      ...
      async function downloadText(rawText, onError) {
        ...
        if (!plain) return;
        // Long RVC/Index reads are chunked with no single output file yet; skip
        // rather than starting a wasteful probe+prewarm conversion job on the
        // Host. Cloud chunked jobs likewise have no single file (packets are
        // billed per packet, so re-synthesizing for download would double-bill).
        if ((shared.provider === "rvc" || shared.provider === "index-tts2" || shared.provider === "cosyvoice" || shared.provider === "google-cloud-tts") && plain.length > 60) {
        ...
        try {
          ...
          if (result && result.url) {
            ...
            a.download = shared.provider === "index-tts2" || shared.provider === "cosyvoice" ? "dsh-tts.wav" : "dsh-tts.mp3";
      ...
      const CSS =
        ...
        ".dsh-tts-toast-ok{border-color:var(--dsw-alias-label-success,var(--dsw-alias-label-secondary))}" +
        ...
        ".dsh-tts-diag-skip{color:var(--dsw-alias-label-tertiary)}" +
        ...
        ".dsh-tts-reading-bar{display:inline-flex;align-items:center;gap:7px;padding:6px 14px;border-radius:10px;background:var(--dsw-alias-bg-layer-3);border:1px solid var(--dsw-alias-border-l2);box-shadow:0 3px 16px rgba(0,0,0,.22),0 0 30px rgba(0,0,0,.08);font-size:12px;line-height:1;color:var(--dsw-alias-label-primary);white-space:nowrap;transition:transform .35s cubic-bezier(.4,0,.2,1),opacity .35s ease;transform:translateX(12px);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);pointer-events:none;cursor:pointer}" +
            ...
            // v2 block highlight (visual anchor for follow): soft background,
            // no box-shadow (never reintroduce the shadow style).
            ".dsh-tts-sentence-active{background:var(--dsw-alias-bg-layer-2);border-radius:6px;transition:background-color .3s ease}" +
            // Resume-follow pill: appears only after the user latches follow off.
            ".dsh-tts-follow-pill{margin-top:4px;padding:4px 12px;border-radius:10px;background:var(--dsw-alias-bg-layer-3);border:1px solid var(--dsw-alias-border-l2);box-shadow:0 3px 16px rgba(0,0,0,.22);font-size:12px;line-height:1;color:var(--dsw-alias-label-primary);white-space:nowrap;cursor:pointer}" +
      ...
      function _ttsClearHighlight() {
        try {
          if (shared.followHlEl) {
            try { shared.followHlEl.classList.remove("dsh-tts-sentence-active"); } catch (e) {}
            shared.followHlEl = null;
          }
        } catch (e) {}
      ...
      function TtsReadingOverlay() {
        ...
        // --- Scroll-follow v2: visibility-driven minimal scrolling ---
        // Design: docs/scroll-follow-v2.md. Block-index stepwise signal (no
        // intra-chunk interpolation — the old equal-slice timing estimate
        // drifted against variable-length chunks and snapped at boundaries);
        // whole-message anchor only; scroll only when the current block
        // leaves the viewport (block:"nearest"); user takeover latches off
        // with manual resume; reduced-motion respected. No polling loop:
        // evaluation runs per chunk-index change + on scroll/touch/viewport
        // events (the old 250ms full-DOM scan forced reflow at 4Hz).
        // NOTE: ttsFollow lives in apply scope (shared singleton) — do NOT
        // redeclare here, or speakText can't see it (0.6.3 ReferenceError).
        const ttsReducedMotion = () => {
          try { return !!(window.matchMedia && window.matchMedia("(prefers-reduced-motion: reduce)").matches); } catch (e) { return false; }
        };
        // Which chunk is sounding (1-based). Stepwise: no fake glide inside
        // a chunk, so pause/playback-rate can never desync the position.
        const ttsBlockIdx = () => {
          const progress = shared.chunkProgress;
          if (!shared.speaking || !progress || !progress.total) return null;
          return Math.min(Math.max(shared.readingIndex || 1, 1), progress.total);
        };
        // Approximate text sounding at block idx (equal division). Used ONLY
        // to locate the paragraph for scroll/highlight — never for timing.
        // Server spans (P1-3) make this exact; until then, advisory mapping.
        const ttsBlockHead = (idx, total) => {
          const full = shared.currentText || "";
          if (!full || !total || total <= 0) return "";
          // Exact server spans when present (P1-3), equal-division fallback.
          const sp = shared.chunkSpans;
          let slice = "";
          if (Array.isArray(sp) && sp[idx - 1] && sp[idx - 1].length === 2 &&
              Number.isFinite(sp[idx - 1][0]) && Number.isFinite(sp[idx - 1][1])) {
            slice = full.slice(Math.max(0, sp[idx - 1][0]), Math.max(0, sp[idx - 1][1]));
          } else {
            slice = full.slice(Math.floor(full.length * (idx - 1) / total), Math.floor(full.length * idx / total));
          }
          return slice.replace(/\s+/g, " ").trim().slice(0, 30);
        };
        const ttsFollowTick = () => {
          ...
          // Latched off: the user took over — stay parked until they tap
          // "resume follow". No auto-recovery (the old 5s yield yanked the
          // view back mid-read, the #1 follow complaint).
          if (!ttsFollow.latched) { mark("latched-off"); return false; }
          if (ttsReducedMotion()) { mark("reduced-motion"); return false; }
          if (shared.paused) { mark("paused"); return false; } // paused: hold still, don't drift
          const idx = ttsBlockIdx();
          const total = (shared.chunkProgress && shared.chunkProgress.total) || 0;
          if (idx == null || !total) { mark("no-ratio"); return false; }
          diag.idx = idx;
          try {
            ...
            const ratio = total ? (idx - 1) / total : 0;
            ...
            if (!msgEl) { mark("no-msgEl"); return false; }
              mark("fragile"); // paragraph fallback: usable for this tick only,
              // never cached as the anchor (caching it froze follow in §C).
            } else { mark("anchored"); }
            // Block locate + highlight happen below; the anchor itself is
            // never replaced by a paragraph hit (see "fragile" above).

            // Current block: the paragraph sounding now. Searched inside the
            // anchor by the block's head text; falls back to the anchor
            // itself (highlighting the whole message is still truthful).
            const containerRect = scrollEl.getBoundingClientRect();
            const head = ttsBlockHead(idx, total);
            let blockEl = msgEl;
            if (head && head.length >= 10 && msgEl.querySelectorAll) {
              try {
                const cands = msgEl.querySelectorAll("p,li,div,section,blockquote,pre,td");
                for (const c of cands) {
                  if (c === msgEl) continue;
                  try {
                    if (c.querySelector && c.querySelector("p,li,div,section,blockquote,pre,td")) continue; // leaf-ish only
                  } catch (e) {}
                  let t = "";
                  try { t = (c.textContent || "").trim().replace(/\s+/g, " "); } catch (e) {}
                  if (t && t.length > 10 && t.includes(head.slice(0, 20))) { blockEl = c; break; }
                }
              } catch (e) {}
            }
            // Absurd-target guard: no box at all, or nowhere near the viewport.
            let bRect = null;
            try { bRect = blockEl.getBoundingClientRect(); } catch (e) {}
            if (!bRect || !(bRect.height > 0) ||
                bRect.bottom < containerRect.top - containerRect.height * 3 ||
                bRect.top > containerRect.bottom + containerRect.height * 3) {
              mark("bad-target");
              diag.guard = {
                h: bRect ? Math.round(bRect.height) : -1,
                contH: Math.round(containerRect.height),
                tag: (blockEl.tagName || "?") + "." + String(blockEl.className || "").slice(0, 60),
              };
              return false;
            }
            // Block highlight (the visual anchor follow was missing): move it
            // as chunks advance. Whole-message fallback still truthful.
            try {
              const prev = shared.followHlEl;
              if (prev && prev !== blockEl) {
                try { prev.classList.remove("dsh-tts-sentence-active"); } catch (e) {}
              }
              if (blockEl.classList) {
                try { blockEl.classList.add("dsh-tts-sentence-active"); } catch (e) {}
                shared.followHlEl = blockEl;
              }
            } catch (e) {}
            // First tick of a click-initiated read: centre once for instant
            // feedback. (readingCenterOnce is only ever set for manual reads;
            // auto-read never yanks the view.)
            if (shared.readingCenterOnce) {
              shared.readingCenterOnce = false;
              let msgTop0 = 0;
              let msgH0 = 0;
              try {
                const msgRect0 = msgEl.getBoundingClientRect();
                msgTop0 = msgRect0.top - containerRect.top + scrollEl.scrollTop;
                msgH0 = msgRect0.height;
              } catch (e) {}
              ttsFollow.selfUntil = Date.now() + 300;
              try {
                scrollEl.scrollTo({ top: Math.max(0, msgTop0 + msgH0 / 2 - containerRect.height / 2), behavior: "auto" });
              } catch (e) {}
              mark("centred");
              return true;
            }
            // Minimal scroll: fully visible (24px grace) → touch nothing.
            // Otherwise scrollIntoView nearest = smallest move that reveals it.
            // (Reduced-motion users never reach here: gated above.)
            const pad = 24;
            if (bRect.top >= containerRect.top + pad && bRect.bottom <= containerRect.bottom - pad) {
              mark("in-view");
              return true;
            }
            ttsFollow.selfUntil = Date.now() + 600;
            try {
              blockEl.scrollIntoView({ block: "nearest", behavior: "smooth" });
            } catch (e) {}
            mark("nearest-scrolled");
            return true;
          } catch (e) { mark("threw:" + String((e && e.message) || e).slice(0, 60)); return false; }
        };
        // Stepwise evaluation: only chunk-index changes can move the target
        // (no intra-chunk glide), so no polling loop is needed.
        react.useEffect(() => {
          ttsFollowTick();
        }, [speaking, readingIdx, cp && cp.index, shared.showScrollFollow]);
        // Takeover detection (event-driven, no polling):
        // - wheel with delta / touchmove gesture / pointer drag with buttons
        //   = confirmed user intent → latch off (stays off until the resume
        //   pill). Host autoscroll during streaming emits none of these, so
        //   live-growing replies no longer freeze follow.
        // - our own smooth scrollIntoView is fenced by selfUntil (cleared
        //   early by scrollend, 600ms fallback) so it never latches us off;
        //   momentum tails after a user flick land post-latch (no-op).
        // - visualViewport resize (mobile URL bar) re-evaluates geometry.
        react.useEffect(() => {
          if (!speaking || !shared.showScrollFollow) return undefined;
          const scrollEl = _ttsFindScrollContainer() ||
            (typeof document !== "undefined" && document.scrollingElement) || null;
          const isSelf = () => Date.now() < ttsFollow.selfUntil;
          const latchOff = () => {
            if (ttsFollow.latched) {
              ttsFollow.latched = false;
              try { notify(); } catch (e) {}
            }
          };
          const onWheel = (e) => {
            if (isSelf()) return;
            try {
              if ((e.deltaY || e.deltaX) !== 0) latchOff();
            } catch (err) {}
          };
          const onTouchStart = () => { ttsFollow.touchActive = true; };
          const onTouchMove = () => { if (!isSelf()) latchOff(); };
          const onTouchEnd = () => { ttsFollow.touchActive = false; };
          const onPointerMove = (e) => {
            if (isSelf()) return;
            try { if (e.buttons && e.buttons !== 0) latchOff(); } catch (err) {}
          };
          const onScrollEnd = () => { ttsFollow.selfUntil = 0; };
          const onViewResize = () => { ttsFollowTick(); };
          const regs = [];
          const listen = (target, type, fn) => {
            try {
              if (target) { target.addEventListener(type, fn, { passive: true }); regs.push([target, type, fn]); }
            } catch (e) {}
          };
          listen(scrollEl, "wheel", onWheel);
          listen(scrollEl, "touchstart", onTouchStart);
          listen(scrollEl, "touchmove", onTouchMove);
          listen(scrollEl, "touchend", onTouchEnd);
          listen(scrollEl, "pointermove", onPointerMove);
          listen(scrollEl, "scrollend", onScrollEnd);
          try {
            if (window.visualViewport) {
              window.visualViewport.addEventListener("resize", onViewResize);
              regs.push([window.visualViewport, "resize", onViewResize]);
            }
          } catch (e) {}
          return () => {
            for (const r of regs) {
              try { r[0].removeEventListener(r[1], r[2]); } catch (e) {}
            }
          };
        ...
        return react.createElement(
          ...
          // Resume-follow pill (v2 latch-off): only after the user takes over.
          (shared.showScrollFollow && speaking && !ttsFollow.latched && !ttsReducedMotion()
            ? react.createElement(
              "button",
              {
                className: "dsh-tts-follow-pill",
                title: t("follow.resume"),
                onClick: (e) => {
                  if (e) { try { if (typeof e.stopPropagation === "function") e.stopPropagation(); } catch (err) {} }
                  ttsFollow.latched = true;
                  try { ttsFollowTick(); } catch (err) {}
      ...
      function ReadAloudButton(props) {
        ...
        const onClick = () => {
          ...
          try {
            ...
            let depth = 0;
            const climbLog = [];
            // Prefer the flowItem (single message item) over the column root:
            // the column holds the WHOLE conversation (len 6572 vs target 434)
            // so ratio-over-column barely moves and lags ~10s. A class match
            // on flowItem/message/item wins even if its current text is short
            // (virtualized bodies report len=38 while collapsed).
            const ITEM_RE = /flowitem|flow-item|message|msg-item|chat-item|list-item/i;
            while (el && depth < 10) {
              let len = 0;
              let h = 0;
              ...
              climbLog.push((el.tagName || "?") + "." + cls.slice(0, 40) + " len=" + len + " h=" + Math.round(h));
              if (h > 60 && (ITEM_RE.test(cls) || (len > 100 && len < Math.max(800, target.length * 3)))) {
                best = el;
                if (ITEM_RE.test(cls)) break;
              }
              if (len > Math.max(500, target.length * 0.6) && h > 60 && !/column|list|container|scroll|content/i.test(cls)) break;
              el = el.parentElement;
              depth++;
            }
            try {
          ...
          speakText(target, "manual", msg => {
            // In RVC/Index/Cloud mode offer one-click "read with Edge instead" —
            // always available, independent of the opt-in auto-fallback toggle.
            const action =
              shared.provider === "rvc" || shared.provider === "index-tts2" || shared.provider === "cosyvoice" || shared.provider === "google-cloud-tts"
                ? {
      ...
      function VoiceSettingsPanel() {
        ...
        // ---- 本地 CosyVoice（提示音频克隆）----
        const [, setCosyTick] = react.useState(0);
        const setCosy = (key, value) => {
          shared.cosy[key] = value;
          saveSettings();
          if (HOST_COSY_KEYS.indexOf(key) >= 0) {
            const patch = {};
            patch[key] = value;
            pushHostCosy(patch);
          }
        ...
        const [cosyVoices, setCosyVoices] = react.useState({ loading: false, error: null, list: [] });
        const refreshCosyVoices = async () => {
          setCosyVoices({ loading: true, error: null, list: [] });
          try {
            const r = await fetch(
              "/dsh-tts-api/cosy-voices?baseUrl=" + encodeURIComponent(shared.cosy.baseUrl),
            );
            const data = await r.json().catch(() => null);
            if (!r.ok || !data || data.error) {
              throw new Error(hostErrText(data) || ("HTTP " + r.status));
            ...
            const list = Array.isArray(data.voices) ? data.voices : [];
            setCosyVoices({ loading: false, error: null, list });
            // auto-select the first voice when nothing is chosen yet
            if (!shared.cosy.voice && list.length) setCosy("voice", list[0]);
            else setCosyTick(n => n + 1);
          } catch (e) {
            setCosyVoices({
              loading: false,
              error: t("cosy.voices.fail") + String((e && e.message) || e),
              list: [],
            });
          }
        };
        const [cosyUpload, setCosyUpload] = react.useState(null); // { busy, error, ok }
        const uploadCosyVoice = async file => {
          if (!file) return;
          setCosyUpload({ busy: true, error: null, ok: null });
          try {
            const buf = await file.arrayBuffer();
            let binary = "";
            const bytes = new Uint8Array(buf);
            ...
            const r = await fetch("/dsh-tts-api/cosy-upload", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                baseUrl: shared.cosy.baseUrl,
                filename: file.name,
                audioBase64: btoa(binary),
              }),
            });
            ...
            const name = data.filename || file.name;
            setCosyUpload({ busy: false, error: null, ok: t("cosy.upload.ok") + name });
            await refreshCosyVoices();
            if (name) setCosy("voice", name);
          } catch (e) {
            setCosyUpload({ busy: false, error: t("cosy.upload.fail") + String((e && e.message) || e), ok: null });
          }
        };
        // entering the CosyVoice provider auto-loads the voice list once
        react.useEffect(() => {
          if (provider === "cosyvoice" && !cosyVoices.loading && !cosyVoices.list.length && !cosyVoices.error) {
            refreshCosyVoices();
          }
        }, [provider]);
        // ---- Google Cloud TTS（付费在线音色）----
        const [, setCloudTick] = react.useState(0);
        const setCloud = (key, value) => {
          shared.cloud[key] = value;
          saveSettings();
          setCloudTick(n => n + 1);
        };
        // Key input is write-only local state (never saved, never from Host).
        const [cloudKey, setCloudKey] = react.useState("");
        const [cloudProject, setCloudProject] = react.useState(null); // null = not loaded yet
        const [cloudSave, setCloudSave] = react.useState(null); // { busy, ok, error }
        const [cloudTest, setCloudTest] = react.useState(null); // { busy, ok, error }
        const [cloudUsage, setCloudUsage] = react.useState(null); // { loading, error, month, tiers } | null
        // entering the Cloud provider pulls key-status + usage once
        react.useEffect(() => {
        ...
        // keep the Project ID input in sync with the Host value once loaded
        react.useEffect(() => {
          if (cloudProject === null && shared.cloudHost && typeof shared.cloudHost.projectId === "string") {
            setCloudProject(shared.cloudHost.projectId);
          }
        });
        const refreshCloudUsage = async () => {
          setCloudUsage({ loading: true, error: null, month: "", tiers: null });
          try {
            const r = await fetch("/dsh-tts-api/cloud-usage");
            const data = await r.json().catch(() => null);
            if (!r.ok || !data || data.error) {
              throw new Error(hostErrText(data) || ("HTTP " + r.status));
            }
            setCloudUsage({ loading: false, error: null, month: data.month || "", tiers: data.tiers || null });
          } catch (e) {
            setCloudUsage({ loading: false, error: String((e && e.message) || e), month: "", tiers: null });
          }
        };
        const saveCloudConfig = async () => {
          const patch = {};
          if (cloudKey.trim() !== "") patch.apiKey = cloudKey.trim();
          if (cloudProject !== null) patch.projectId = cloudProject.trim();
          if (!patch.apiKey && cloudProject === null) return;
          setCloudSave({ busy: true, ok: null, error: null });
          try {
            const r = await fetch("/dsh-tts-api/cloud-config-save", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ cloud: patch }),
            });
            ...
            refreshCloudConfig();
            refreshCloudUsage();
            setCloudSave({ busy: false, ok: t("cloud.saved"), error: null });
          } catch (e) {
            setCloudSave({ busy: false, ok: null, error: String((e && e.message) || e) });
          }
        };
        const clearCloudKey = async () => {
          if (!window.confirm(t("cloud.confirmClear.lead") + t("cloud.confirmClear.tail"))) return;
          setCloudSave({ busy: true, ok: null, error: null });
          try {
            const r = await fetch("/dsh-tts-api/cloud-config-save", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ cloud: { apiKey: "" } }),
            });
            const data = await r.json().catch(() => null);
            if (!r.ok || !data || data.error) {
              throw new Error(hostErrText(data) || ("HTTP " + r.status));
            ...
            setCloudKey("");
            refreshCloudConfig();
            setCloudSave({ busy: false, ok: t("cloud.cleared"), error: null });
          } catch (e) {
            setCloudSave({ busy: false, ok: null, error: String((e && e.message) || e) });
          }
        };
        const testCloudKey = async () => {
          setCloudTest({ busy: true, ok: null, error: null });
          try {
            const r = await fetch("/dsh-tts-api/cloud-test", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ voice: shared.cloud.voice || "cmn-CN-Wavenet-A" }),
            });
            const data = await r.json().catch(() => null);
            if (!r.ok || !data || data.error) {
              throw new Error(hostErrText(data) || ("HTTP " + r.status));
            ...
            refreshCloudUsage();
            setCloudTest({ busy: false, ok: t("cloud.test.ok"), error: null });
          } catch (e) {
            setCloudTest({ busy: false, ok: null, error: String((e && e.message) || e) });
          }
        };
        // ---- 文件选择器（RVC 服务文件发现）----
        ...
        const [diag, setDiag] = react.useState(null); // { running, checks, error, recent, worker, plugin, activeJobs }
        const runDiagnose = async () => {
          setDiag({ running: true, checks: null, error: null, recent: [], worker: null, plugin: null, activeJobs: [] });
          try {
            const r = await fetch("/dsh-tts-api/diagnose", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({
                rvcBaseUrl: shared.rvc.baseUrl,
                indexBaseUrl: shared.index.baseUrl,
                cosyBaseUrl: shared.cosy.baseUrl,
                cloudProbe: shared.provider === "google-cloud-tts" ? "1" : "",
                cloudVoice: shared.cloud.voice || "",
              }),
            });
            const d = await r.json().catch(() => null);
            if (!r.ok || !d || d.error) {
            ...
            setDiag({ running: false, checks: d.checks || [], error: null, recent: d.recent || [], worker: d.worker || null, plugin: d.plugin || null, activeJobs: d.activeJobs || [] });
            return d;
          } catch (e) {
            setDiag({ running: false, checks: null, error: String((e && e.message) || e), recent: [], worker: null, plugin: null, activeJobs: [] });
            return null;
          }
        };
        // ---- 导出诊断日志（JSON 文件，AI/开发者可直接用）----
        // Client-side mirror of the Host classifyHostError (same kind codes,
        // same order — keep in sync). Codes only, no UI strings.
        const classifyDiagError = msg => {
          const s = String(msg || "");
          if (/1007|unsupported voice|voice\.removed/i.test(s)) return "voice";
          if (/403|401|Sec-MS-GEC/i.test(s)) return "auth";
          if (/abort-timeout|synthTimeout|timeout|超时/i.test(s)) return "timeout";
          if (/1006|websocket|closed early|closed code|reset|fetch failed|network|load failed|decode/i.test(s)) return "network";
          if (/chunk|prewarm|stall/i.test(s)) return "chunk";
          return "unknown";
        };
        // Build the export object (JSON-serializable, no message text, no keys).
        const buildDiagExport = payload => {
          const hostRecent = ((payload && payload.recent) || []).map(e => ({
            at: new Date(e.at).toISOString(),
            source: "host",
            kind: e.kind || classifyDiagError(e.error),
            provider: e.provider,
            voice: e.voice,
            textLen: e.textLen,
            stage: e.stage || "",
            ms: e.ms,
            // job-summary entries (stage "job") carry counts, not errors.
            total: e.total,
            served: e.served,
            skipped: e.skipped,
            error: e.error || "",
          }));
          const clientRecent = shared.diagLog.map(e => {
            if (e.kind === "speak") {
              return {
                at: new Date(e.at).toISOString(),
                source: "client",
                event: "speak",
                kind: e.ok ? "speak-ok" : classifyDiagError(e.error),
                provider: e.provider,
                voice: e.voice,
                textLen: Number(e.textLen),
                ms: e.ms,
                cached: !!e.cached,
                error: e.ok ? "" : (e.error || ""),
              };
          ...
          const byKind = {};
          const countKind = k => { if (k && k !== "info") byKind[k] = (byKind[k] || 0) + 1; };
          for (const e of hostRecent) countKind(e.kind || "unknown");
          for (const e of clientRecent) {
            if (e.event === "speak") { if (e.kind !== "speak-ok") countKind(e.kind); }
            else countKind(e.kind);
          }
          const speaks = clientRecent.filter(e => e.event === "speak");
          const speakAttempts = speaks.length;
          return {
            tool: "dsh-tts-diag",
            exportedAt: new Date().toISOString(),
            ua: (() => { try { return navigator.userAgent; } catch (e) { return ""; } })(),
            plugin: (payload && payload.plugin) || null,
            // Build tags pin down WHICH code produced the log: package
            // versions only move on releases, so two different builds are
            // otherwise indistinguishable (exactly what stalled the 1/3/2
            // swap triage — the failing runs predated the fix).
            clientBuild: CLIENT_BUILD,
            hostBuild: (payload && payload.hostBuild) || null,
            // True when the Host predates the extended diagnose response
            // (plugin updated but dsh web not restarted): checks are valid,
            // but worker/recent/plugin are missing — re-run after a restart.
            hostStale: !!(payload && payload.hostStale),
            worker: (payload && payload.worker) || null,
            settings: {
              provider: shared.provider,
              voice: shared.voice,
              prosody: { rate: shared.rvc.baseRate, pitch: shared.rvc.basePitch, volume: shared.rvc.baseVolume },
              rvcBaseUrl: shared.rvc.baseUrl,
              indexBaseUrl: shared.index.baseUrl,
              indexVoice: shared.index.voice || "",
              cosyBaseUrl: shared.cosy.baseUrl,
              cosyVoice: shared.cosy.voice || "",
              cosyPromptLen: String(shared.cosy.promptText || "").length,
              cloudVoice: shared.cloud.voice || "",
              cloudApiKeySet: !!shared.cloudHost.apiKeySet,
            },
            playback: {
              speaking: !!shared.speaking,
              jobId: shared.currentJobId || null,
              chunkProgress: shared.chunkProgress,
              stalling: !!shared.stalling,
            },
            activeJobs: (payload && payload.activeJobs) || [],
            checks: ((payload && payload.checks) || []).map(c => ({
              id: c.id || "",
              name: c.name,
              ok: !!c.ok,
              cls: c.cls || "",
            ...
            summary: {
              hostErrors: hostRecent.length,
              clientEvents: clientRecent.length,
              speakAttempts,
              speakFails: speaks.filter(e => e.kind !== "speak-ok").length,
              cachedHits: speaks.filter(e => e.kind === "speak-ok" && e.cached).length,
              byKind,
            },
            hostRecent,
            clientRecent,
        ...
        const exportDiagLog = async () => {
          try {
            // Always a fresh run: reusing cached checks risks exporting a stale
            // state (e.g. plugin/worker null from before a dsh restart), which
            // is indistinguishable from a stale Host in the log.
            const payload = await runDiagnose();
            if (!payload || !payload.checks) throw new Error(t("diag.fail") + ((diag && diag.error) || "?"));
            payload.hostStale = !(payload.plugin && payload.worker);
            const text = JSON.stringify(buildDiagExport(payload), null, 2);
            const stamp = new Date().toISOString().slice(0, 19).replace(/[-:T]/g, "");
            const filename = "dsh-tts-diag-" + stamp + ".json";
            let done = false;
            try {
              // BOM first: without it, Windows Notepad opens the file as GBK
              // on Chinese systems and all CJK comes out mojibake (seen live).
              ...
              setTimeout(() => { try { URL.revokeObjectURL(url); } catch (e3) {} }, 5000);
              done = true;
            ...
            if (!done) throw new Error(t("diag.exportFail"));
            showToast(t("diag.exported"), "ok");
          } catch (e) {
        ...
        const diagMark = c =>
          c.ok ? react.createElement("span", { className: "dsh-tts-diag-ok" }, "✓")
            : c.cls === "warn"
              ...
              : c.cls === "skip"
                ? react.createElement("span", { className: "dsh-tts-diag-skip" }, "–")
          ...
          react.createElement(
            ...
            react.createElement(
              "span",
              {
                className:
                  "dsh-tts-diag-detail " +
                  (c.ok ? "dsh-tts-diag-ok" : c.cls === "warn" ? "dsh-tts-diag-warn" : c.cls === "skip" ? "dsh-tts-diag-skip" : "dsh-tts-diag-fail"),
              },
              c.detail || "",
            ),
          );
        ...
        const cosyTextIn = (key, placeholder) =>
          react.createElement("input", {
            className: "dsh-tts-rvc-input",
            value: shared.cosy[key],
            placeholder: placeholder,
            onChange: e => setCosy(key, e.target.value),
          });
        const cosyNum = (key, step, min) =>
          react.createElement("input", {
            className: "dsh-tts-rvc-input dsh-tts-rvc-input-num",
            type: "number",
            step: step,
            min: min,
            value: shared.cosy[key],
            onChange: e => setCosy(key, Number(e.target.value)),
          });
        const cosySlider = (key, min, max, step, fmt) =>
          react.createElement(
            "div",
            { className: "dsh-tts-slider" },
            react.createElement("input", {
        ...
        const cosyField = (label, control, note) =>
          react.createElement(
            "div",
            { className: "dsh-tts-field" },
            react.createElement(
        ...
        const cosySection = react.createElement(
          "div",
          { className: "dsh-tts-module dsh-tts-module-stack dsh-tts-rvc" },
          react.createElement(
            "div",
          ...
          cosyField(
            t("cosy.field.baseUrl"),
            cosyTextIn("baseUrl", "http://127.0.0.1:7890"),
            t("cosy.field.baseUrl.tip"),
          ),
          cosyField(
            t("cosy.field.voice"),
            react.createElement(
              "div",
              { className: "dsh-tts-path" },
              cosyVoices.list.length
                ? react.createElement(
                    "select",
                    {
                      className: "dsh-tts-rvc-input dsh-tts-select",
                      value: shared.cosy.voice,
                      onChange: e => setCosy("voice", e.target.value),
                    },
                    react.createElement("option", { key: "", value: "" }, "—"),
                    cosyVoices.list.map(v =>
                      react.createElement("option", { key: v, value: v }, v),
                    ),
                  )
                : cosyTextIn("voice", "prompt.wav"),
              react.createElement(
                "button",
                {
                  type: "button",
                  className: "dsh-tts-browse",
                  onClick: refreshCosyVoices,
                  disabled: !!cosyVoices.loading,
                },
                cosyVoices.loading ? t("cosy.refreshing") : t("cosy.refresh"),
              ),
            ),
            cosyVoices.error
              ? react.createElement(
              ...
              : (!cosyVoices.loading && !cosyVoices.list.length
                  ? t("cosy.voices.none")
                  : t("cosy.field.voice.tip")),
          ),
          cosyField(
            t("cosy.upload"),
            react.createElement(
              ...
              react.createElement("input", {
                type: "file",
                accept: ".wav,.mp3,.flac,.m4a,.ogg,audio/*",
                disabled: !!(cosyUpload && cosyUpload.busy),
                onChange: e => {
                  const f = e.target.files && e.target.files[0];
                  if (f) uploadCosyVoice(f);
                  try { e.target.value = ""; } catch (err) {}
                },
              }),
              (cosyUpload && cosyUpload.busy)
                ? react.createElement("span", { className: "dsh-tts-compact-info" }, t("cosy.uploading"))
                : null,
            ),
            (cosyUpload && (cosyUpload.error || cosyUpload.ok))
              ? react.createElement(
                  "div",
                  { className: cosyUpload.error ? "dsh-tts-error" : "dsh-tts-compact-info dsh-tts-compact-ok" },
                  cosyUpload.error || cosyUpload.ok,
                )
              : t("cosy.upload.tip"),
          ),
          cosyField(
            t("cosy.field.speed"),
            cosySlider("speed", 0.5, 2.0, 0.1, v => String(v)),
            t("cosy.field.speed.tip"),
          ),
          cosyField(
            t("cosy.field.seed"),
            cosyNum("seed", 1, 0),
            t("cosy.field.seed.tip"),
          ),
          cosyField(
            t("cosy.field.promptText"),
            react.createElement("textarea", {
              className: "dsh-tts-rvc-input",
              rows: 3,
              value: shared.cosy.promptText,
              placeholder: t("cosy.field.promptText.placeholder"),
              onChange: e => setCosy("promptText", e.target.value),
            }),
            t("cosy.field.promptText.tip"),
          ),
        );

        const cloudField = (label, control, note) =>
          react.createElement(
            "div",
            { className: "dsh-tts-field" },
            react.createElement(
        ...
        const cloudHost = shared.cloudHost || {};
        const cloudUsageRows = (cloudUsage && cloudUsage.tiers)
          ? ["standard", "wavenet", "neural2", "chirp3"].map(tier =>
              react.createElement(
                "div",
                { key: tier, className: "dsh-tts-diag-row" },
                react.createElement("span", { className: "dsh-tts-diag-name" }, t("cloud.usage." + tier)),
                react.createElement(
                  "span",
                  { className: "dsh-tts-diag-detail" },
                  (cloudUsage.tiers[tier].used || 0).toLocaleString() + " / " +
                    (cloudUsage.tiers[tier].limit || 0).toLocaleString() + " " + t("cloud.usage.unit"),
                ),
              ),
            )
          : null;
        const cloudSection = react.createElement(
          "div",
          { className: "dsh-tts-module dsh-tts-module-stack dsh-tts-rvc" },
          react.createElement(
            "div",
          ...
          react.createElement(
            ...
            react.createElement(
              "div",
              { className: "dsh-tts-onboard-title" },
              t("cloud.onboard.title"),
            ),
            react.createElement(
              "div",
              { className: "dsh-tts-onboard-desc" },
              t("cloud.onboard.desc"),
            ),
            react.createElement(
              "button",
              {
          ...
          cloudField(
            ...
            react.createElement(
              ...
              react.createElement(
                ...
                {
                  className: "dsh-tts-rvc-input dsh-tts-select",
                  value: CLOUD_VOICES.indexOf(shared.cloud.voice) >= 0 ? shared.cloud.voice : "__custom",
                  onChange: e => {
                    if (e.target.value !== "__custom") setCloud("voice", e.target.value);
                  },
                },
                CLOUD_VOICES.map(v =>
                  react.createElement("option", { key: v, value: v }, v),
                ),
                react.createElement("option", { key: "__custom", value: "__custom" }, t("cloud.voice.custom")),
              ),
              CLOUD_VOICES.indexOf(shared.cloud.voice) >= 0
                ? null
                : react.createElement("input", {
                    className: "dsh-tts-rvc-input",
                    value: shared.cloud.voice,
                    placeholder: "cmn-CN-Neural2-A",
                    onChange: e => setCloud("voice", e.target.value),
                  }),
            ),
            t("cloud.voice.tip"),
          ),
          cloudField(
            ...
            react.createElement(
              ...
              react.createElement("input", {
                ...
                type: "password",
                value: cloudKey,
                placeholder: t("cloud.key.placeholder"),
                autoComplete: "off",
              ...
              react.createElement(
                "button",
                {
                  ...
                  disabled: !!(cloudSave && cloudSave.busy),
                },
                (cloudSave && cloudSave.busy) ? t("cloud.saving") : t("cloud.save"),
              ),
            ),
            (cloudHost.apiKeySet ? t("cloud.key.saved") + cloudHost.apiKeyTail + "。" : "") + t("cloud.key.tip"),
          ),
          cloudField(
            t("cloud.project"),
            react.createElement("input", {
              className: "dsh-tts-rvc-input",
              value: cloudProject === null ? (cloudHost.projectId || "") : cloudProject,
          ...
          (cloudSave && (cloudSave.error || cloudSave.ok))
            ? react.createElement(
                "div",
                { className: cloudSave.error ? "dsh-tts-error" : "dsh-tts-compact-info dsh-tts-compact-ok" },
                cloudSave.error || cloudSave.ok,
              )
            : null,
          cloudField(
            t("cloud.test"),
            react.createElement(
              ...
              react.createElement(
                "button",
                {
                  ...
                  disabled: !!(cloudTest && cloudTest.busy) || !cloudHost.apiKeySet,
                },
                (cloudTest && cloudTest.busy) ? t("cloud.testing") : t("cloud.test"),
              ),
              cloudHost.apiKeySet
                ? react.createElement(
                    "button",
                    {
                      type: "button",
                      className: "dsh-tts-browse dsh-tts-pack-uninstall",
                      onClick: clearCloudKey,
                      disabled: !!(cloudSave && cloudSave.busy),
                    },
                    t("cloud.clear"),
                  )
                : react.createElement("span", { className: "dsh-tts-compact-info" }, t("host.cloudNoKey")),
            ),
            (cloudTest && (cloudTest.error || cloudTest.ok))
              ? react.createElement(
                  "div",
                  { className: cloudTest.error ? "dsh-tts-error" : "dsh-tts-compact-info dsh-tts-compact-ok" },
                  cloudTest.error || cloudTest.ok,
                )
              : t("cloud.voice.tip"),
          ),
          react.createElement(
            ...
            react.createElement(
              "div",
              { className: "dsh-tts-module-title" },
              t("cloud.usage.title") + (cloudUsage && cloudUsage.month ? " · " + cloudUsage.month : ""),
            ),
            react.createElement(
              "div",
              { className: "dsh-tts-preview-row" },
              react.createElement(
                "button",
                {
                  ...
                  disabled: !!(cloudUsage && cloudUsage.loading),
                },
                (cloudUsage && cloudUsage.loading) ? t("cloud.usage.loading") : t("cloud.usage.refresh"),
              ),
            ),
          ),
          cloudUsage && cloudUsage.error
            ? react.createElement("div", { className: "dsh-tts-error" }, cloudUsage.error)
            : null,
          cloudUsageRows,
          react.createElement(
            "div",
            { className: "dsh-tts-module-desc" },
            t("cloud.usage.localNote"),
          ),
        );
        ...
        return react.createElement(
          ...
          provider !== "rvc" && provider !== "index-tts2" && provider !== "cosyvoice" && provider !== "google-cloud-tts"
            ? react.createElement(
                "div",
                { className: "dsh-tts-module" },
                react.createElement(
            ...
            : null,
          provider === "index-tts2" || provider === "cosyvoice" || provider === "google-cloud-tts" ? null : soundSection,
          provider === "rvc" ? rvcSection : null,
          provider === "rvc" ? packSection() : null,
          provider === "index-tts2" ? indexSection : null,
          provider === "cosyvoice" ? cosySection : null,
          provider === "google-cloud-tts" ? soundSection : null,
          provider === "google-cloud-tts" ? cloudSection : null,
          diagModule(),
          react.createElement(
            "div",
            { className: "dsh-tts-module dsh-tts-module-stack" },
            ...
            isPreviewPlaying && shared.chunkProgress && shared.chunkProgress.total > 1
              ? react.createElement(
                  ...
                  t("chunk.playing.lead") +
                    ...
                    (shared.stalling ? t("chunk.stalling") : t("chunk.playing.tail")),
                )
              : null,
          ),
          react.createElement(
          ...
          react.createElement(
            ...
            react.createElement(
              "a",
              {
                href: "https://github.com/1624318455/dsh-plugin-tts/issues",
                target: "_blank",
                rel: "noreferrer",
              },
              "https://github.com/1624318455/dsh-plugin-tts/issues",
            ),
            t("report.hint.tail"),
          ),
          picker
