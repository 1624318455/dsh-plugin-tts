      ...
      const I18N = {
        ...
        dict: {
          zh: {
            ...
            "indexEntry.title": "想用本地 Index-TTS2 音色？",
            "indexEntry.desc": "用你电脑上 index-tts2-nvidia 包里的参考音频音色朗读，完全本地合成；需先启动它的 API 服务",
            "indexEntry.open": "展开本地音色（Index-TTS2）",
...
"tab.voice": "语音",
          ...
          en: {
            ...
            "indexEntry.title": "Want a local Index-TTS2 voice?",
            "indexEntry.desc": "Read with reference-audio voices from your local index-tts2-nvidia bundle, fully local; start its API service first",
            "indexEntry.open": "Show local voice (Index-TTS2)",
...
"tab.voice": "Voice",
      ...
      // Shared helpers for scroll-to-centre and highlight
      ...
      function TtsReadingOverlay() {
        ...
        // --- Scroll-to-centre + shadow highlight (inside this known-rendered component) ---
        react.useEffect(() => {
          if (!shared.showScrollFollow || !visible || idx <= 0) return;
          try {
        ...
        }, [visible, idx, total, shared.showScrollFollow]);

        // --- Cleanup highlight when speaking stops ---
        react.useEffect(() => {
          if (!shared.speaking) {
            ...
            ? react.createElement(
                ...
                react.createElement(
                  "button",
                  {
                    ...
                    className: "dsh-tts-browse",
                    onClick: () => {
                      shared.provider = "index-tts2";
                      saveSettings();
                      setProvider("index-tts2");
                    },
                  },
                  t("indexEntry.open"),
                ),
