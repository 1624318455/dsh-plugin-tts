      ...
      const I18N = {
        ...
        dict: {
          zh: {
            ...
            "section.rvc": "RVC 配置",
            "rvc.desc": "用你自己训练好的音色模型来朗读。需要先在电脑上启动一个转换服务（见 README 使用手册），再在这里填好模型路径",
            "field.baseUrl": "服务地址",
            ...
            "host.filesNeedsServer": "浏览文件需要先启动本地 RVC 服务",
            "host.chunkFail": "后续段落合成失败",
            "host.compactNeedsServer": "生成紧凑索引需要先启动本地 RVC 服务",
...
"tab.voice": "语音",
          ...
          en: {
            ...
            "rvc.desc": "Read with your own trained voice model. Start a conversion service on this PC first (see README), then fill in the model path here",
            ...
            "host.filesNeedsServer": "Browsing files requires the local RVC service to be running",
            "host.chunkFail": "Later-section synthesis failed",
            "host.compactNeedsServer": "Compacting the index requires the local RVC service to be running",
...
"tab.voice": "Voice",
      ...
      function hostErrText(obj) {
        ...
        if (i18n && i18n.code && I18N.dict.zh[i18n.code] !== undefined) {
          ...
          if (translated !== i18n.code) return translated;
        }
      ...
      async function speakText(rawText, source, onError) {
        ...
        try {
          ...
          if (!result || result.error) {
            ...
            return {
              ok: false,
              error: String((result && result.error) || t("err.synthFailShort")),
            };
          }
          const el = shared.audioEl;
          if (!el) {
