...
"tab.voice": "Voice",
      ...
      function AutoReadToggle(props) {
        ...
        react.useEffect(() => {
          ...
          if (prev === undefined) {
            // First sight of this session: record the baseline WITHOUT
            // speaking so existing history never replays on refresh/switch.
            // An empty session baselines at -1, so its very first reply
            // (maxSeq > -1) WILL speak instead of being eaten as "history".
