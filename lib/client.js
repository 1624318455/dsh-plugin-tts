  ...
  factory: require => {
    ...
    const apply = ctx => {
      ...
      async function rpcSpeak(text, voice) {
        ...
        if (shared.provider === "rvc") payload.custom = shared.rvc;
      ...
      const CSS =
        ...
        ".dsh-tts-rvc-label{flex:none;width:120px;font-size:12px;color:var(--dsw-alias-label-secondary);text-align:right}" +
        ...
        ".dsh-tts-rvc-hint{flex:none;font-size:11px;color:var(--dsw-alias-label-tertiary);white-space:nowrap}" +
        ...
        ".dsh-tts-advanced .dsh-tts-rvc-row{margin:6px 0}" +
      ...
      function VoiceSettingsPanel() {
        ...
        const rvcRow = (label, control, hint) =>
          react.createElement(
            "div",
        ...
        const rvcSection = react.createElement(
          ...
          rvcRow(
            ...
            react.createElement("input", {
              className: "dsh-tts-rvc-input",
              value: shared.rvc.baseUrl,
              placeholder: "http://127.0.0.1:4892",
              onChange: e => setRvc("baseUrl", e.target.value),
            }),
          ),
          rvcRow(
            "模型路径 (.pth)",
            react.createElement("input", {
              className: "dsh-tts-rvc-input",
              value: shared.rvc.model,
              placeholder: "E:\\...\\assets\\weights\\xxx.pth",
              onChange: e => setRvc("model", e.target.value),
            }),
          ),
          rvcRow(
            "索引路径 (.index)",
            react.createElement("input", {
              className: "dsh-tts-rvc-input",
              value: shared.rvc.index,
              placeholder: "留空 = 免索引",
              onChange: e => setRvc("index", e.target.value),
            }),
            "留空 = 免索引（index_rate 自动为 0）",
          ),
          rvcRow(
            "底噪音色",
            react.createElement(
              "select",
              {
                ...
                value: shared.rvc.baseVoice,
                onChange: e => setRvc("baseVoice", e.target.value),
              },
              BASE_VOICES.map(v =>
                react.createElement(
                  "option",
          ...
          react.createElement(
            ...
            rvcRow(
              ...
              react.createElement("input", {
                className: "dsh-tts-rvc-input",
                value: shared.rvc.baseRate,
                placeholder: "default",
                onChange: e => setRvc("baseRate", e.target.value),
              }),
              "如 +10% / -10%",
            ),
            rvcRow(
              ...
              react.createElement("input", {
                className: "dsh-tts-rvc-input",
                value: shared.rvc.basePitch,
                placeholder: "default",
                onChange: e => setRvc("basePitch", e.target.value),
              }),
            ),
            rvcRow(
              "底噪音量",
              react.createElement("input", {
                className: "dsh-tts-rvc-input",
                value: shared.rvc.baseVolume,
                placeholder: "default",
                onChange: e => setRvc("baseVolume", e.target.value),
              }),
            ),
            rvcRow(
              "说话人 ID spk_id",
            ...
            rvcRow(
              ...
              react.createElement(
                ...
                {
                  className: "dsh-tts-rvc-input dsh-tts-select",
                  value: shared.rvc.f0Method,
                  onChange: e => setRvc("f0Method", e.target.value),
                },
                ["rmvpe", "pm", "harvest", "crepe"].map(m =>
                  react.createElement("option", { key: m, value: m }, m),
                ),
              ),
              "rmvpe 质量高，pm 快",
            ),
            rvcRow("变调（半音）", num("f0UpKey", 1, -24)),
            rvcRow("索引权重 index_rate", num("indexRate", 0.05, 0)),
            rvcRow("输出采样率 resample_sr", num("resampleSr", 1000, 16000)),
            rvcRow("响度混合 rms_mix_rate", num("rmsMixRate", 0.05, 0)),
            rvcRow("辅音保护 protect", num("protect", 0.05, 0)),
            rvcRow("滤波半径 filter_radius", num("filterRadius", 1, 0), "仅 harvest 有效"),
            rvcRow(
              "F0 曲线文件",
              react.createElement("input", {
                className: "dsh-tts-rvc-input",
                value: shared.rvc.f0File,
                placeholder: "留空 = 自动提取音高",
                onChange: e => setRvc("f0File", e.target.value),
              }),
              "手动指定音高曲线",
            ),
          ),
          ...
          react.createElement(
            ...
            react.createElement(
              "select",
              {
                ...
                disabled: provider === "rvc" || undefined,
              },
              voiceOptions,
            ),
          ),
