...
window.__ModuleLoader__.load({
  ...
  factory: require => {
    ...
    const CLIENT_BUILD = "2026-09-26.01-prewarm-skip-toast";
    const apply = ctx => {
...
"tab.voice": "Voice",
      ...
      const shared = {
        ...
        speaking: false,
        diagLog: [], // one-click diagnostic log: recent speak attempts + toasts (no message text, textLen only; cap 20)
        currentText: null,
        speakSource: null,
        speakToken: 0,
      ...
      function logDiag(entry) {
        try {
          ...
          while (shared.diagLog.length > 20) shared.diagLog.shift();
