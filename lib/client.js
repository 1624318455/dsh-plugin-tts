      ...
      const I18N = {
        ...
        dict: {
          zh: {
            ...
            "provider.help": "Edge TTS：免费在线音色，开箱即用；自定义音色（RVC）：用你自己训练的模型，需先启动转换服务；本地音色（Index-TTS2）：用本机 index-tts2-nvidia 包的参考音频音色，需先双击「启动api服务.bat」；Cloud TTS：谷歌付费在线音色（中文标准/波形），需自备 API Key",
            ...
            "footnote": "由 Microsoft Edge TTS / 本地 RVC / 本地 Index-TTS2 / Google Cloud TTS 驱动。",
...
"tab.voice": "语音",
          ...
          en: {
            ...
            "footnote": "Powered by Microsoft Edge TTS / local RVC / local Index-TTS2 / Google Cloud TTS.",
...
"tab.voice": "Voice",
      ...
      function loadSettings() {
        try {
          ...
          if (data.provider === "edge-tts" || data.provider === "rvc" || data.provider === "index-tts2" || data.provider === "google-cloud-tts")
      ...
      function saveSettings() {
        try {
          ...
          // (only baseUrl is service-class). Cloud apiKey/projectId NEVER
          // persist to localStorage — they live in the Host file only; the
      ...
      async function downloadText(rawText, onError) {
        ...
        if ((shared.provider === "rvc" || shared.provider === "index-tts2" || shared.provider === "google-cloud-tts") && plain.length > 60) {
      ...
      function ReadAloudButton(props) {
        ...
        const onClick = () => {
          ...
          speakText(target, "manual", msg => {
            ...
            const action =
              shared.provider === "rvc" || shared.provider === "index-tts2" || shared.provider === "google-cloud-tts"
                ? {
      ...
      function VoiceSettingsPanel() {
        ...
        return react.createElement(
          ...
          provider !== "rvc" && provider !== "index-tts2" && provider !== "google-cloud-tts"
            ? react.createElement(
                "div",
                { className: "dsh-tts-module" },
                react.createElement(
            ...
            : null,
          provider === "index-tts2" || provider === "google-cloud-tts" ? null : soundSection,
