      ...
      const I18N = {
        ...
        dict: {
          zh: {
            ...
            "report.hint": "遇到问题？点上方诊断区的「导出诊断日志」，把 JSON 发给开发者；本地服务报错另附服务终端里的红色报错。",
...
"tab.voice": "语音",
          ...
          en: {
            ...
            "report.hint": "Hit a bug? Export the diagnostic log in Diagnostics above and send the JSON to the developer; for local-service errors also paste the red traceback from the service terminal.",
