      ...
      function VoiceSettingsPanel() {
              ...
              try {
                ...
                if (d && d.waiting !== true && d.total) {
                  ...
                  setInstallProg({
                    ...
                    phase: d.phase === t("tab.index") ? t("tab.index") : t("tab.model"),
                    speed: d.speed || 0,
                  });
                  continue;
                }
        ...
        const installPack = async (pack, indexId) => {
            ...
            while (!settled) {
              ...
              try {
                ...
                setInstallProg({
                  ...
                  phase: finished ? t("packs.done") : d.phase === t("tab.index") ? t("tab.index") : t("tab.model"),
                  speed: d.speed || 0,
                });
          ...
          if (d && !d.error && d.ok !== false) {
            ...
            setPackNote({
              ok: false,
              text: t("packs.installFail") + String((d && d.error) || t("packs.unknownError")),
            });
          }
          setInstallProg(null);
          setInstalling(null);
