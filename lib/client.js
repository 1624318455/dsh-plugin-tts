...
"tab.voice": "Voice",
      ...
      const CSS =
        ...
        /* ---- sentence highlight (bottom shadow projection, not font shadow) ---- */
        ".dsh-tts-sentence-active{position:relative;transition:box-shadow .6s cubic-bezier(.4,0,.2,1);box-shadow:0 4px 12px -2px rgba(var(--dsw-alias-brand-primary-rgb,79,140,255),.45),0 6px 20px -4px rgba(0,0,0,.2);border-radius:4px}" +
        ".dsh-tts-sentence-prev{transition:box-shadow .5s cubic-bezier(.4,0,.2,1);box-shadow:none}" +
      ...
      function TtsReadingOverlay() {
        useI18n();
        useSharedForce();
        const visible = shared.showReadingOverlay && shared.speaking && shared.readingIndex != null && shared.chunkProgress && shared.chunkProgress.total > 1;
        ...
        return react.createElement(
          ...
          react.createElement(
            "div",
            {
              ...
              onClick: onBarClick,
              title: shared.paused ? t("mini.resume") : t("mini.pause"),
            },
