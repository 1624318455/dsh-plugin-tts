...
window.__ModuleLoader__.load({
  ...
  factory: require => {
    ...
    const CLIENT_BUILD = "2026-09-20.3-live-follow-compact";
    const apply = ctx => {
...
"tab.voice": "Voice",
      ...
      function TtsReadingOverlay() {
        ...
        const keepVisible = () => {
          ...
          if (Date.now() - ttsUserScrollAt.t < 5000) return false;
          if (shared.paused) return false; // paused: hold still, don't drift
        ...
        react.useEffect(() => {
          ...
          const scrollEl = _ttsFindScrollContainer();
          const onUserScroll = () => { ttsUserScrollAt.t = Date.now(); };
          try {
